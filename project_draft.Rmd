...
filtered_df |>
  lm(h4bmi ~ first_generation + age_standardized + sex + race, data = _) |> 
  broom::tidy()  |> 
...
```{r}
filtered_df |>
  lm(h4sbp ~ first_generation + age_standardized + bio_sex4 + h1gi8, data = _) |> 
  broom::tidy()  |> 
  knitr::kable(digits = 4)

filtered_df |>
  lm(h4dbp ~ first_generation + age_standardized + bio_sex4 + h1gi8, data = _) |> 
  broom::tidy()  |> 
  knitr::kable(digits = 4)
```
